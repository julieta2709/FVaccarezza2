  ...
  return (
    <div className="Aboutme-Maincontainer">
      ...
      <div className="Aboutme-container">
        ...
        <div className="About1a6-container">
          <div className="Aboutme-1">
            ...
            <div className="Aboutme-description">
              ...
              <p className="Aboutme-text">
                ...
                studied several years at the universidad of buenos aires
                (U.B.A.), from industrial to graphic design. Been always
                passionate about style in all it forms and started exploring
                this world many years ago.
              </p>
            </div>
          </div>
